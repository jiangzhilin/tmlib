...
import com.liuge.z02sckhd_6wqgx.entity.MiaoshaEntity;
...
public class AddBuyMiaoshaPop extends PopupWindow {
    private static final String TAG = "AddBuyPop";
    static Activity mContext;
    public static AddBuyMiaoshaPop dialog;
    static View view;
    ...
    public AddBuyMiaoshaPop(@NonNull Context context) {
        super(context);
...
//                View item=LayoutInflater.from(mContext).inflate(R.layout.z02sckhd_6wqgx_item_layout_layble,null);
//                RadioButton rb = (RadioButton) item.findViewById(R.id.rb_item);
                RadioButton rb = new RadioButton(mContext);
                rb.setBackgroundResource(R.drawable.z02sckhd_6wqgx_radio_shape_blue_bg);
                rb.setButtonDrawable(new ColorDrawable(Color.TRANSPARENT));
                rb.setTextColor(mContext.getResources().getColorStateList(R.drawable.z02sckhd_6wqgx_saixuan_txt_slector));
