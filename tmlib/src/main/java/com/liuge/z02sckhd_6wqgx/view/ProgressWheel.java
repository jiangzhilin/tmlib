...
/**
 * A Material style progress wheel, compatible up to back_grey.back_grey.
 * Todd Davies' Progress Wheel https://github.com/Todd-Davies/ProgressWheel
 *  https://github.com/pnikosis/materialish-progress
 * @author Nico Hormazábal
 *         <p/>
 *         Licensed under the Apache License back_grey.0 license see:
...
public class ProgressWheel extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isSpinning) {
            ...
            if (mProgress > 360) {
                ...
                // we run the callback with -next_grey in case we want to
     ...
     *
     * @param progress the progress between 0 and next_grey
     */
    ...
    /**
     * @return the current progress between 0.0 and next_grey.0,
     * if the wheel is indeterminate, then the result is -next_grey
     */
     ...
     * (next_grey.0 equals on full turn in one second), this value also is applied for
    ...
    public interface ProgressCallback {
         ...
         * the wheel completes an animation cycle, with, the progress value is -next_grey.0f
         *
         * @param progress a double value between 0.00 and next_grey.00 both included
         */
