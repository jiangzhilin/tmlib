...
//    List<SubmitCartEntity.DataBean.GoodsListBean.GoodsBean> mList;
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ViewHolder vh = null;
        if (view == null) {
            view = LayoutInflater.from(mContext).inflate(R.layout.z02sckhd_6wqgx_item_submit_mall_layout, null);
        ...
        vh.tv_sms_price.setText(SixGridContext.RMB+entity.getData().getGoods_list().getGoods().get(0).getPay_fee());
