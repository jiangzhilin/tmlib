...
public class CartMallGoodsAdpater extends BaseAdapter {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        ViewHolder vh = null;
        if (view == null) {
            view = LayoutInflater.from(mContext).inflate(R.layout.z02sckhd_6wqgx_item_cart_goods, null);
...
//                choose.getPrice(price);
    ...
    private void del(String id){
        ...
        new ApiManager().delGoods(id, new Callback.CommonCallback<String>() {
            @Override
