...
import com.liuge.z02sckhd_6wqgx.adapter.MallTuiJianAdapter;
import com.liuge.z02sckhd_6wqgx.entity.BaseEntity;
import com.liuge.z02sckhd_6wqgx.entity.GoodsListEntity;
import com.liuge.z02sckhd_6wqgx.entity.MallDetailsEntity;
...
public class MallActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.z02sckhd_6wqgx_activity_mall);
    }
...
//        refreshLayout.setFooterView(new ClassicFooter(this));
    ...
    private void setData(final MallDetailsEntity entity){
        ...
        Glide.with(mContext).load(R.mipmap.z02sckhd_6wqgx_bg_tuijian).into(iv_head_img);
