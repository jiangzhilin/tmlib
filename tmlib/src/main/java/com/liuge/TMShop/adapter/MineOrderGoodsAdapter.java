...
import com.liuge.TMShop.ui.CommentActivity;
import com.liuge.TMShop.ui.TuiHuanHuoActivity;
...
public class MineOrderGoodsAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ViewHolder vh = null;
        if (view == null) {
            view = LayoutInflater.from(mContext).inflate(R.layout.item_submit_goods_layout, null);
